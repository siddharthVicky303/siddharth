...
<head>
    ...
    <style>
        ...
        tr:nth-child(even) { background-color: rgb(238, 236, 236); }
...
<select name="id">
    ...
    <?php foreach (array_unique($ids) as $id) : ?>
        <option value="<?php echo htmlspecialchars($id); ?>" <?php echo ($selectedID === $id) ? 'selected' : ''; ?>><?php echo htmlspecialchars($id); ?></option>
    <?php endforeach; ?>
</select>
...
<select name="year">
    ...
    <?php foreach (array_unique($years) as $year) : ?>
        <option value="<?php echo htmlspecialchars($year); ?>" <?php echo ($selectedYear === $year) ? 'selected' : ''; ?>><?php echo htmlspecialchars($year); ?></option>
    <?php endforeach; ?>
</select>
