...
$csvFile = "HSS REVIEW Report (22).csv"; // Your CSV file
...
<body>
    ...
    <form method="GET" class="search-bar">
        <input type="text" name="search" placeholder="Search by Name, Roll No, or Discipline" value="<?php echo htmlspecialchars($searchQuery); ?>">
    ...
    <table>
        ...
        foreach ($students as $student): 
            $studentDetails = strtolower($student['Student Detail']); // Convert to lowercase for case-insensitive search
            if ($searchQuery === '' || strpos($studentDetails, $searchQuery) !== false):
                $found = true;
        ?>
            <tr>
                <td><?php echo $student['s/n']; ?></td>
                <td><?php echo nl2br($student['Student Detail']); ?></td>
                <td>
                    <?php 
