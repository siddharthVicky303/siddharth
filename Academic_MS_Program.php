 ...
 <nav class="navbar navbar-expand-lg navbar-light nav-castom_1">
  ...
  <div class="container mt-4">
    <div class="card shadow">
        <div class="card-body">
          <h6 class="card-title"><p class="card-text">  <h4 style="text-align: center;">MS Research: from 2021 </h4><br>
           <p style="text-align: center;">  Since the School had a well-established and robust PhD programme, we deliberated on a Master’s programme for quite some time. Finally, after a lot <br>of brainstorming and discussions, the school proposed an MS (Research) programme that was debated and approved by the Institute Senate in 2021.</p>
         <div style="margin-left:7% ">   
  <?php include 'MS_Program.php';?>
  </div>
           </p></h6>
